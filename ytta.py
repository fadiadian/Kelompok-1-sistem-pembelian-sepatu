...
class GudangSepatu:
    ...
    def kurangi_sepatu(self, jenis, merek, series, ukuran,kode, jumlah):
        #if (jenis, merek, series, ukuran,kode) in self.data_sepatu.index:
    ...
    def tampilkan_menu_dari_data(self, jenis_menu):
        ...
        for index, row in df_filtered.iterrows():
            ...
            print(f"  Kode: {kode}")
            print("=========================================")
            menu_list.append((jenis, merek, series, ukuran, kode, row['harga'], row['jumlah']))
            count += 1
        return menu_list
...
def main_program():
    ...
    while True:
        ...
        if lihat_menu == 1:
            ...
            jenis = input("Masukkan jenis sepatu: ")
            menu_list = gudang.tampilkan_menu_dari_data(str(jenis))
            if menu_list:
